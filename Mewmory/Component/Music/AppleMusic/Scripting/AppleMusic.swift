...
// MARK: AppleMusicEKnd
@objc public enum AppleMusicEKnd : AEKeyword {
...
// MARK: AppleMusicEnum
@objc public enum AppleMusicEnum : AEKeyword {
    case standard = 0x6c777374 /* b'lwst' */
    case detailed = 0x6c776474 /* b'lwdt' */
}

// MARK: AppleMusicEPlS
@objc public enum AppleMusicEPlS : AEKeyword {
...
// MARK: AppleMusicERpt
@objc public enum AppleMusicERpt : AEKeyword {
...
// MARK: AppleMusicEShM
@objc public enum AppleMusicEShM : AEKeyword {
...
// MARK: AppleMusicESrc
@objc public enum AppleMusicESrc : AEKeyword {
...
// MARK: AppleMusicESrA
@objc public enum AppleMusicESrA : AEKeyword {
...
// MARK: AppleMusicESpK
@objc public enum AppleMusicESpK : AEKeyword {
...
// MARK: AppleMusicEMdK
@objc public enum AppleMusicEMdK : AEKeyword {
...
// MARK: AppleMusicERtK
@objc public enum AppleMusicERtK : AEKeyword {
    case user = 0x6b527455 /* b'kRtU' */
    case computed = 0x6b527443 /* b'kRtC' */
}

// MARK: AppleMusicEAPD
@objc public enum AppleMusicEAPD : AEKeyword {
    ...
    case tv = 0x6b415056 /* b'kAPV' */
    case unknown = 0x6b415055 /* b'kAPU' */
}

// MARK: AppleMusicEClS
@objc public enum AppleMusicEClS : AEKeyword {
    case unknown = 0x6b556e6b /* b'kUnk' */
    ...
    case prerelease = 0x6b507252 /* b'kPrR' */
    case noLongerAvailable = 0x6b526576 /* b'kRev' */
    case notUploaded = 0x6b557050 /* b'kUpP' */
}

// MARK: AppleMusicEExF
@objc public enum AppleMusicEExF : AEKeyword {
    case plainText = 0x6b545854 /* b'kTXT' */
    case unicodeText = 0x6b554354 /* b'kUCT' */
    case xml = 0x6b584d4c /* b'kXML' */
    case m3U = 0x6b4d3355 /* b'kM3U' */
    case m3U8 = 0x6b4d3338 /* b'kM38' */
}

// MARK: AppleMusicGenericMethods
@objc public protocol AppleMusicGenericMethods {
...
@objc public protocol AppleMusicApplication: SBApplicationProtocol {
    ...
    @objc optional var currentAirPlayDevices: [AppleMusicAirPlayDevice] { get } // the currently selected AirPlay device(s)
    @objc optional var currentEncoder: AppleMusicEncoder { get } // the currently selected encoder (MP3, AIFF, WAV, etc.)
    @objc optional var currentEQPreset: AppleMusicEQPreset { get } // the currently selected equalizer preset
    @objc optional var currentPlaylist: AppleMusicPlaylist { get } // the playlist containing the currently targeted track
    ...
    @objc optional var currentTrack: AppleMusicTrack { get } // the current targeted track
    @objc optional var currentVisual: AppleMusicVisual { get } // the currently selected visual plug-in
    ...
    @objc optional func add(_ x: [URL]!, to: SBObject!) -> AppleMusicTrack // add one or more files to a playlist
    ...
    @objc optional func convert(_ x: [SBObject]!) -> AppleMusicTrack // convert one or more files or tracks
    ...
    @objc optional func setCurrentAirPlayDevices(_ currentAirPlayDevices: [AppleMusicAirPlayDevice]!) // the currently selected AirPlay device(s)
    @objc optional func setCurrentEncoder(_ currentEncoder: AppleMusicEncoder!) // the currently selected encoder (MP3, AIFF, WAV, etc.)
    @objc optional func setCurrentEQPreset(_ currentEQPreset: AppleMusicEQPreset!) // the currently selected equalizer preset
    @objc optional func setCurrentVisual(_ currentVisual: AppleMusicVisual!) // the currently selected visual plug-in
...
// MARK: AppleMusicItem
@objc public protocol AppleMusicItem: SBObjectProtocol, AppleMusicGenericMethods {
    ...
    @objc optional func exportAs(_ as: AppleMusicEExF, to: URL!) -> String // export a source or playlist
...
@objc public protocol AppleMusicAirPlayDevice: AppleMusicItem {
...
@objc public protocol AppleMusicArtwork: AppleMusicItem {
...
@objc public protocol AppleMusicEncoder: AppleMusicItem {
...
@objc public protocol AppleMusicEQPreset: AppleMusicItem {
...
@objc public protocol AppleMusicPlaylist: AppleMusicItem {
    @objc optional func tracks() -> SBElementArray
    ...
    @objc optional var favorited: Bool { get } // is this playlist favorited?
    @objc optional var parent: AppleMusicPlaylist { get } // folder which contains this playlist (if any)
    ...
    @objc optional func searchFor(_ for_: String!, only: AppleMusicESrA) -> AppleMusicTrack // search a playlist for tracks matching the search string. Identical to entering search text in the Search field.
    ...
    @objc optional func setFavorited(_ favorited: Bool) // is this playlist favorited?
}
extension SBObject: AppleMusicPlaylist {}

// MARK: AppleMusicAudioCDPlaylist
@objc public protocol AppleMusicAudioCDPlaylist: AppleMusicPlaylist {
...
@objc public protocol AppleMusicLibraryPlaylist: AppleMusicPlaylist {
...
@objc public protocol AppleMusicRadioTunerPlaylist: AppleMusicPlaylist {
    @objc optional func URLTracks() -> SBElementArray
}
extension SBObject: AppleMusicRadioTunerPlaylist {}

// MARK: AppleMusicSource
@objc public protocol AppleMusicSource: AppleMusicItem {
...
@objc public protocol AppleMusicSubscriptionPlaylist: AppleMusicPlaylist {
    @objc optional func fileTracks() -> SBElementArray
    @objc optional func URLTracks() -> SBElementArray
}
...
@objc public protocol AppleMusicTrack: AppleMusicItem {
    @objc optional func artworks() -> SBElementArray
    ...
    @objc optional var albumFavorited: Bool { get } // is the album for this track favorited?
    ...
    @objc optional var favorited: Bool { get } // is this track favorited?
    ...
    @objc optional func setAlbumFavorited(_ albumFavorited: Bool) // is the album for this track favorited?
...
@objc public protocol AppleMusicAudioCDTrack: AppleMusicTrack {
...
@objc public protocol AppleMusicFileTrack: AppleMusicTrack {
    @objc optional var location: URL { get } // the location of the file represented by this track
...
@objc public protocol AppleMusicSharedTrack: AppleMusicTrack {
}
extension SBObject: AppleMusicSharedTrack {}

// MARK: AppleMusicURLTrack
@objc public protocol AppleMusicURLTrack: AppleMusicTrack {
...
@objc public protocol AppleMusicUserPlaylist: AppleMusicPlaylist {
    @objc optional func fileTracks() -> SBElementArray
    @objc optional func URLTracks() -> SBElementArray
    @objc optional func sharedTracks() -> SBElementArray
...
@objc public protocol AppleMusicFolderPlaylist: AppleMusicUserPlaylist {
}
extension SBObject: AppleMusicFolderPlaylist {}

// MARK: AppleMusicVisual
@objc public protocol AppleMusicVisual: AppleMusicItem {
}
extension SBObject: AppleMusicVisual {}

// MARK: AppleMusicWindow
@objc public protocol AppleMusicWindow: AppleMusicItem {
...
@objc public protocol AppleMusicBrowserWindow: AppleMusicWindow {
    @objc optional var selection: SBObject { get } // the selected tracks
    @objc optional var view: AppleMusicPlaylist { get } // the playlist currently displayed in the window
    @objc optional func setView(_ view: AppleMusicPlaylist!) // the playlist currently displayed in the window
}
extension SBObject: AppleMusicBrowserWindow {}

// MARK: AppleMusicEQWindow
@objc public protocol AppleMusicEQWindow: AppleMusicWindow {
}
extension SBObject: AppleMusicEQWindow {}

// MARK: AppleMusicMiniplayerWindow
@objc public protocol AppleMusicMiniplayerWindow: AppleMusicWindow {
}
extension SBObject: AppleMusicMiniplayerWindow {}

// MARK: AppleMusicPlaylistWindow
@objc public protocol AppleMusicPlaylistWindow: AppleMusicWindow {
    @objc optional var selection: SBObject { get } // the selected tracks
    @objc optional var view: AppleMusicPlaylist { get } // the playlist displayed in the window
}
extension SBObject: AppleMusicPlaylistWindow {}

// MARK: AppleMusicVideoWindow
@objc public protocol AppleMusicVideoWindow: AppleMusicWindow {
}
